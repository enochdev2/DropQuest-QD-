...
export default function ManagerDashboard() {
  ...
  const fetchManagerReferrals = async (managerEmail) => {
    ...
    try {
      ...
      while (true) {
        const response = await fetch(
          `https://dropquest-qd-backend.onrender.com/api/v1/user/managersref?managerEmail=${managerEmail}&page=${page}`, // CHANGED: Added managerEmail query param
          {
            method: "GET",
            headers: {
              Authorization: `Bearer ${token}`,
...
//   const [showManagers, setShowManagers] = useState(false);
//   const [selectedManager, setSelectedManager] = useState("manager01@gmail.com");
//   const [unlocked, setUnlocked] = useState(false);
//   const [expandedManager, setExpandedManager] = useState(null);
//   const [expandedUser, setExpandedUser] = useState(null);
//   const [managerSearchTerm, setManagerSearchTerm] = useState("");
...
//     },
//     {
//       email: "test01111@gmail.com",
//       name: "Test Test Test",
//       phone: "010-1111-1111",
//       telegram: "@test1111111",
//       referral: "manager01@gmail.com",
//       registrationDate: "2025-10-15",
//     },
//     {
//       email: "te124s12t01111@gmail.com",
//       name: "Test1 kim",
//       phone: "010-1111-1111",
//       telegram: "@test1test1",
//       referral: "manager01@gmail.com",
...
//       phone: "010-2222-2222",
//       telegram: "@mgr2user",
//       referral: "manager02@gmail.com",
//       registrationDate: "2025-10-13",
//     },
//     {
//       email: "test03@gmail.com",
//       name: "Another for mgr2",
//       phone: "010-3333-3333",
//       telegram: "@another2",
//       referral: "manager02@gmail.com",
...
//       while (true) {
//         const response = await fetch(
//           `${BASE_URL}/api/v1/user/managersref?page=${page}`
//         );
//         if (!response.ok) {
//           throw new Error("Failed to fetch users");
//         }
...
//       while (true) {
//         const response = await fetch(
//           `${BASE_URL}/api/v1/user/managers?page=${page}`
//         );
//         if (!response.ok) {
//           throw new Error("Failed to fetch managers");
//         }
//         const data = await response.json();
//         if (!data.managers || data.managers.length === 0) break;
//         fetchedManagers = [...fetchedManagers, ...data.managers];
//         if (data.managers.length < 10) break;
//         page++;
//       }
//       setAllManagers(fetchedManagers.map((manager) => manager.email));
//     } catch (error) {
//       console.error("Error fetching managers:", error);
//     }
//   };
...
//     setSelectedManager("manager01@gmail.com");
//     setShowManagers(false);
//     setExpandedManager(null);
//     setExpandedUser(null);
//     setSearchTerm("");
...
//   const displayedManagers = managers.filter((manager) =>
//     manager.toLowerCase().includes(managerSearchTerm.toLowerCase())
//   );

//   const managerUsersForTable = (manager) =>
//     users
//       .filter((user) => user.referral === manager)
//       .sort(
//         (a, b) => new Date(b.registrationDate) - new Date(a.registrationDate)
//       );
...
//                 {/* Pagination for Managers (optional, simplified) */}
//                 <div className="flex justify-center items-center gap-3 mt-20">
//                   <span className="bg-orange-700 px-3 py-2 rounded-md">
//                     Page
//                   </span>
//                   <button className="px-3 py-2 rounded-md bg-orange-600">
//                     1
//                   </button>
//                 </div>
//               </>

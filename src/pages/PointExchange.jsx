...
import { getTokenSlots, getUserProfile, submitPointExchange } from "@/lib/utilityFunction"
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className=" bg-gray-900 py-16 px-4">
        <div className=" text-center">
          <h1 className="text-4xl font-bold mb-4 text-white">{t("pointExchangeTitle")}</h1>
          <p className="text-xl text-gray-300 mb-4">Exchange your accumulated points for various cryptocurrencies</p>
          <div className="bg-gray-800 border border-gray-700 rounded-lg p-4 mb-8 inline-block">
            <p className="text-lg">
              ...
              <span className="text-2xl font-bold text-blue-400">{userPoints.toLocaleString()}</span>
            </p>
          </div>
...
<div className="py-12 px-4">
  <div className="">
    <h2 className="text-2xl font-bold text-center mb-8 text-white">{t("availableTokens")}</h2>
            ...
            <CardContent className="p-4 text-center">
              {token.isConfigured ? (
                <>
                  ...
                  <p className="text-xs text-gray-400">{token.pointRatio} pts</p>
                </>
              ) : (
                <>
      ...
      {showExchangeModal && selectedToken && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <Card className="bg-gray-800 border-gray-700 w-full max-w-md">
            <CardHeader>
              <CardTitle className="text-center text-white">{t("exchangePoints")}</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-white">${selectedToken.tokenName}</h3>
                <p className="text-gray-300">
                  1 {selectedToken.tokenName} = {selectedToken.pointRatio} Points
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-xs text-gray-400 mb-4">Points can only be exchanged in units of 1000.</p>
                <Input
                  type="number"
              ...
              <p className="text-center text-sm text-gray-300">{t("exchangeRequest")}</p>

              <div className="flex gap-4">
                <Button onClick={handleExchange} disabled={submitting} className="flex-1 bg-blue-600 hover:bg-blue-700">
                  {submitting ? (
                    <>

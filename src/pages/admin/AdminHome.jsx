...
import { RefreshCw, Users, Award, Megaphone, TrendingUp, Activity } from "lucide-react"
...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-cyan-50">
      <div className="px-24 bg-gradient-to-r from-white via-cyan-50 to-white border-b border-cyan-100  py-6 shadow-sm">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-slate-600 mt-2 text-lg" style={{ fontFamily: "DM Sans, sans-serif" }}>
      ...
      <div className="py-6 px-24 ">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <Card className=" bg-gradient-to-br from-white to-cyan-50 border-cyan-200 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-cyan-600" style={{ fontFamily: "DM Sans, sans-serif" }}>
                    {totalUsers}
                  </p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-blue-600" style={{ fontFamily: "DM Sans, sans-serif" }}>
                    {activeSessions}
                  </p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-emerald-600" style={{ fontFamily: "DM Sans, sans-serif" }}>

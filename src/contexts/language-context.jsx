...
const translations = {
  en: {
    ...
    managerDashboard: "DropQuest Manager Dashboard",
  ...
  ko: {
    ...
    walletGuide: "지갑 가이드",
    viewAsImage: "이미지로 보기",
    walletGuideStep1: "팬텀 지갑 실행 → 코인 목록 좌측 상단 [토큰] 클릭",
    walletGuideStep2: "우측 상단의 [관리 버튼] 클릭",
    walletGuideStep3: "입금 받은 코인의 우측 슬라이 바 상태를 [ON]으로 변경",
    walletGuideStep4: "팬텀 지갑 메인 화면으로 돌아가서 입금 받은 코인 클릭",
    walletGuideStep5: "하단의 [스팸 아님으로 신고] 버튼 클릭",
    searchForManagerEmail: "이제부터 코인이 정상적으로 표시됩니다.",
    ...
    managerDashboard: "DropQuest 매니저 페이지",
    numberOfUsers: "유저 수",
